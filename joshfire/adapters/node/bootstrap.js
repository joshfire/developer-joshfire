...
(function() {
  ...
  */
  J = {
    ...
    * @type {Object}
    */
    adapterModules: {"node": ["app.factory", "app", "class", "global.exec", "uielement", "inputs/http", "uielements/page", "uielements/panel", "uielements/panel.manager", "uielements/video.mediaelement", "utils/datasource", "utils/eventsocket", "utils/templatecompiler.cli", "utils/templatecompiler", "vendor/json2"]},
...
(function () {
    ...
    require.load = function (context, moduleName, url) {
        ...
        console.warn("Loading "+moduleName);
